        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>SECURE</h3>
              <h4>Threat-aware engineering</h4>
              <p>
                Designing secure, reliable systems and automating
                risk-aware workflows across cloud backends and analytics
                pipelines.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building ML models and BI dashboards to detect fraud,
                optimize processes, and communicate insights with clarity.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
